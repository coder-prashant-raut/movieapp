...
function Popular( {filtrendingmovie}) {
  ...
  return (
    ...
    {filtrendingmovie.map((filtrendingmovie)=>(
      ...
      <div key={filtrendingmovie.id} class="w-80 max-w-sm max-90 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-10">
          <a href="#">
              <img class="p-0 rounded-t-lg max-h-120 w-1xs" src={`https://image.tmdb.org/t/p/w1280/${filtrendingmovie.poster_path
      }`} alt="product image" />
          </a>
          <div class="px-5 pb-5">
              <a href="#">
